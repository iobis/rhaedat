...
ggplot() +
  ...
  geom_point(data = occ_sorted, aes(decimalLongitude, decimalLatitude, fill = genus), shape = 21, colour = "#ffffff", size = 2.5) +
  scale_fill_manual(values = c("#bf3939", "#56B4E9", "#ffa808")) +
  coord_quickmap(xlim = c(-10, 37), ylim = c(30, 46)) +
  theme(
...
ggsave("demo/output/map_ostreopsis_gambierdiscus_ostreopsis.png", width = 12, height = 7, scale = 1)
...
ggplot() +
  geom_polygon(data = world, aes(x = long, y = lat, group = group), fill = "#eeeeee", colour = "#cccccc", size = 0.3) +
  geom_point(data = occ_sorted, aes(decimalLongitude, decimalLatitude, fill = taxon), shape = 21, colour = "#ffffff", size = 2.5) +
  scale_fill_manual(values = c("#bf3939", "#56B4E9", "#ffa808")) +
  coord_quickmap(xlim = c(-10, 37), ylim = c(30, 46)) +
  theme(
    panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
...
ggsave("demo/output/map_dinophysis_prorocentrum.png", width = 12, height = 7, scale = 1)
...
ggsave("demo/output/map_dinophysis_prorocentrum_allobisdata.png", width = 12, height = 7, scale = 1)
...
ggsave("demo/output/map_alexandrium_gymnodinium_catenatum.png", width = 12, height = 7, scale = 1)
...
ggsave("demo/output/map_pseudonitzschia_good_probable.png", width = 12, height = 7, scale = 1)
...
ggsave("demo/output/map_pseudonitzschia_all.png", width = 12, height = 7, scale = 1)
