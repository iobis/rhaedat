...
colors <- c("#aecde9", "#cdb2ff", "#b280b4", "#8099e4", "#e07f7e", "#f4be9a", "#fedf81", "#b39980", "#7f7f7f", "#b2b299", "#77a877", "#b7d5a6", "#f3c3db")
regions <- c("Region 1 (ECA)", "Region 2 (CCA)", "Region 3 (SAM)", "Region 4 (WCA)", "Region 5 (ANZ)", "Region 6 (SEA)", "Region 7 (NAS)", "Region 8 (Indian Ocean)", "Region 9 (Benguela)", "Region 10 (West Africa)", "Region 11 (MED)", "Region 12 (EUR)", "Region 13 (PAC)")
...
ggplot() +
  ...
  scale_x_continuous(breaks = pretty_breaks(n = 10))
ggsave("demo/output/region_events_split.png", height = 13, width = 7, scale = 0.9)
